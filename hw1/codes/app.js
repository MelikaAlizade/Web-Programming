...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Store current editing note ID globally
    let currentEditingNoteId = null;

    // Calendar variables - FIXED: استفاده از تاریخ محلی بدون درنظرگیری timezone
    let currentDate = new Date();
    let isGregorian = false;
    let selectedDate = null;
    let currentDailyNoteDate = null;

    // Helper function to get date without timezone issues
    ...
    // Notes functionality - ONLY SHOW NOTES WITHOUT DATES
    ...
    function renderNotes() {
        ...
        // Only show notes without dates (general notes)
        ...
        // Add event listeners to all note buttons
    ...
    // Daily Note Modal Functionality
    ...
    // PRECISE JALALI CALENDAR FUNCTIONS
    ...
    // Calendar functionality - FIXED DATE ISSUES
    ...
    function renderCalendar() {
        ...
        // Get first day of month and number of days - FIXED
        ...
        if (isGregorian) {
            ...
            // FIX: +1 day for Jalali calendar start
            firstDay = (firstDayGregorian.getDay() + 1) % 7;

            // Calculate days in Jalali month
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            // Check if this day is today - FIXED
